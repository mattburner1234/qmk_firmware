...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_F1 , KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,                         KC_Y  , KC_U  , KC_I  , KC_O  , KC_P  ,KC_BSLASH,
     KC_F2, KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                         KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_QUOT,
     KC_F3, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_KP_7,
                      KC_F4,KC_LBRACKET,                                                       KC_RBRACKET, KC_EQL,
                                      KC_F5,KC_SPC,                        KC_KP_6, KC_KP_1,
                                      KC_F6,KC_F8,                         KC_KP_8,  KC_KP_4,
                                      KC_F7, KC_F9,                        KC_KP_2, KC_KP_5
  ),
